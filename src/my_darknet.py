...
def detect_image(network, class_names, image, thresh=.5, hier_thresh=.5, nms=.45):
    ...
    image_pred, _ = array_to_image(image)
    predict_image(network, image_pred)
    # predict_image(network, image)
    detections = get_network_boxes(network, image_pred.w, image_pred.h,
...
if os.name == "nt":
    ...
    lib = CDLL("/home/vid/hdd/projects/darknet/libdarknet.so", RTLD_GLOBAL)
